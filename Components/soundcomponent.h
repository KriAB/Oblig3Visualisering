...
class SoundComponent : public Components
{
public:
    ...
    //En lytter, possisjon, upVector,
    //en source, possisjon, hastighet
    //en buffer
    //hastighet, dopplereffekten: bevegelse i forhold til lytter og source. tonehøyde, lysere/mørkere
